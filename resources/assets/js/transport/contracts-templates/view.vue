<template>
    <div class="panel panel-default">
        <div class="panel-heading no-bottom">
            <div class="row">
                <div class="col-sm-6">
                    <h4><strong>Contract Template Details</strong></h4>
                </div>
            </div>
        </div>
        ...
        <div class="panel-body">
            <form action="#" role="form" @submit.prevent="store">
                ...
                <div class="form-group">
                    <router-link to="/contract-templates" class="btn btn-danger">Back</router-link>
                </div>
            </form>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        processContract(endpoint) {
            this.$root.isLoading = true;
            http.post('/api/contract-template/' + this.$route.params.id + '/' + endpoint, {})
                .then((response) => {
                    this.$root.isLoading = false;
