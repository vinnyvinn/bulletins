            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong>Offloading</strong>
                    </div>
                    <div class="panel-body">
                        <h3 class="text-center">{{ application_name }}</h3>
                        <h4 class="text-center text-uppercase">Offloading</h4>
                        <form action="#" @submit.prevent="store">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <h5><strong>Driver: </strong> {{ truck.driver.first_name + ' ' + truck.driver.last_name }}</h5>
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-success" value="Process Offloading">
                            </div>
    ...
    export default {
        mounted() {
            ...
            http.get('/api/trip/' + this.$route.params.id).then((response) => {
                if (response.status == 'success' && response.trip) {
                    ...
                    this.loading.items_loaded = JSON.parse(response.trip.delivery_note.fields).items_loaded;
        ...
        methods: {
            store() {
                ...
                http.post('/api/enroute/' + this.$route.params.id, this.loading).then(response => {
                    ...
                    setTimeout(() => {
                        ...
                        window._router.push({path: '/progress/enroute'});
