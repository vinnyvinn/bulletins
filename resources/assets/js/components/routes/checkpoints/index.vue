                            ...
                            <div class="col-sm-7">
                                <transition name="custom-classes-transition" enter-active-class="animated flipInX" leave-active-class="animated flipOutX">
                                    <div v-if="showImport">
                                        ...
                                        <h6 class="pull-right">
                                            <a target="_blank" href="/templates/routes.xls">Download Sample</a>
                                        </h6>
                                    </div>
                                </transition>
                            </div>
                            <div class="col-sm-3">
                                <a class="btn btn-info btn-xs pull-right" @click="showImport = !showImport">
                                    <i class="fa fa-inbox"></i> Import</a>
                                <router-link to="/routes/create" class="btn btn-primary btn-xs pull-right">
                            ...
                            <tbody>
                                <tr v-for="route in routes">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <span @click="edit(route)" class="btn btn-xs btn-info">
                                            <i class="fa fa-pencil"></i>
                                        </span>
                                        <button data-toggle="popover" :data-item="route.id" class="btn btn-xs btn-danger btn-destroy">
