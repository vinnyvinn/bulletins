            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong>Disapproved External Services</strong>

                        <router-link to="/wsh/external/closed" class="btn btn-danger btn-xs pull-right">
                            <i class="fa fa-plus"></i> Closed
                        </router-link>

                        <router-link to="/wsh/external" class="btn btn-primary btn-xs pull-right">
                            <i class="fa fa-plus"></i> Pending
                        </router-link>

                        <router-link to="/wsh/external/disapproved" class="btn btn-warning btn-xs pull-right">
...
<script>
    export default {
        created() {
            http.get('/api/services?status=Declined').then(response => {
