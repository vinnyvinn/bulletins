                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <select disabled required v-model="requisition.vendor_id" name="vendor_id" id="vendor_id" class="form-control input-sm">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="number" step="0.01" class="form-control" v-model="requisition.approximate_cost" id="approximate_cost">
                        </div>
