                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select disabled required v-model="requisition.job_card_id" name="job_card_id" id="job_card_id" class="form-control input-sm">
                        ...
                        <div class="form-group">
                            ...
                            <select disabled required v-model="requisition.type" name="type" id="type" class="form-control input-sm">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea disabled v-model="requisition.mechanic_findings" name="mechanic_findings" id="mechanic_findings" cols="20" rows="5" class="form-control input-sm">{{ card.mechanic_findings }}</textarea>
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods: {
          ...
          approve() {
            http.post('/api/services/' + this.$route.params.id + '/approve', {}).then((response) => {
          ...
          disapprove() {
            http.post('/api/services/' + this.$route.params.id + '/disapprove', {}).then((response) => {
              alert2(this.$root, [response.message], 'success');
              window._router.go(-1);
            }).catch((error) => {
              alert2(this.$root, Object.values(JSON.parse(error.message)), 'danger');
          ...
          close() {
            http.post('/api/services/' + this.$route.params.id + '/close', {}).then((response) => {
              alert2(this.$root, [response.message], 'success');
              window._router.go(-1);
            }).catch((error) => {
              alert2(this.$root, Object.values(JSON.parse(error.message)), 'danger');
