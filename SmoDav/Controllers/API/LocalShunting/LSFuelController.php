...
class LSFuelController extends Controller
{
    ...
    public function lsfuelindex()
    {
        return Response::json([
            'lsfuels' => LSFuel::with('vehicle', 'vehicle.driver', 'user', 'approved_by')
    ...
    {
        return Response::json([
            'lsfuel' => LSFuel::where('id', $id)->with('contract', 'contract.route', 'contract.contractConfig',
                'vehicle', 'vehicle.driver', 'user', 'approved_by')->first(),
        ]);
    }
    ...
    public function approveLSFuel($id)
    {
        ...
        return Response::json([
            ...
            'lsfuel'  => LSFuel::where('id', $id)->with([
                'contract', 'contract.route', 'contract.contractConfig',
                'vehicle', 'vehicle.driver', 'user', 'approved_by'
            ])->first(),
        ]);
    }
