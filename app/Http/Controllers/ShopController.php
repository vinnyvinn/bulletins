...
class ShopController extends Controller
{
    ...
    public function settingsUpdate(Request $request)
    {
        ...
        //File unique name
        $photoName = str_random(7) . \substr(\time(), 4);
    ...
    public function newSales()
    {
        ...
        return view(session('userLevel') . 'new_sales', \compact('pageTitle', 'products', 'shops'));
    }
    ...
    public function shopProducts($id)
    {
        ...
        return view(session('userLevel') . 'shop_products', \compact('shop', 'pageTitle'));
    }
    ...
    public function shopStocks($id)
    {
        ...
        return view(session('userLevel') . 'shop_stocks', \compact('pageTitle', 'shop'));
    }
